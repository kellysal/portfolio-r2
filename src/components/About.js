            ...
            <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-20 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <div className="flex justify-center">
                        ...
                        <a href="https://www.linkedin.com/in/kelly-salamack/">
                            <svg className="h-6 w-6 fill-current m-2 hover:fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
